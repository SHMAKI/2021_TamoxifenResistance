...
gtf <- rtracklayer::import('/Users/s_magi/ReferenceGenome/Homo_sapiens.GRCh38.81.gtf') #これを使っている
...
saveRDS(mitogenes.id, "processed_data/mitogenes.id.rds")
...
saveRDS(rps.id, "processed_data/rps.id.rds")
saveRDS(rpl.id, "processed_data/rpl.id.rds")
